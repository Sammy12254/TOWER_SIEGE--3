...
function draw() {
  ...
  fill("blue");
  textSize(16);
  text("Press SPACE to get other chance to throw Hexagonal Stone",150,50);

  strokeWeight(0);
  fill("blue");
  textSize(16);
  text("If all the blocks are invisible then game over. To play again click on reload button",150,70);
